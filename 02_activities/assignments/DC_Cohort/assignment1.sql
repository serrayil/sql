...
FROM vendor_booth_assignments AS vendbootas
JOIN vendor AS v
  ON v.vendor_id = vendbootas.vendor_id
GROUP BY v.vendor_id, v.vendor_name
ORDER BY times_rented DESC, v.vendor_name;
...
-- creating a temp table new_vendor from the original vendor table
